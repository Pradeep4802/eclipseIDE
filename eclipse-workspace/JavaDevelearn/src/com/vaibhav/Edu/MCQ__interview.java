package com.vaibhav.Edu;
import java.util.Scanner;

public class MCQ__interview {
	...
	public void mcqMethod() {
		...
		String[][] options = {
				...
				{"a) Java is a sequence-dependent programming languag", "b) Java is a code dependent programming language", "c) Java is a platform-dependent programming language", "d) Java is a platform-independent programming language"},
